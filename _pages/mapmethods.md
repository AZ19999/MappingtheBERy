...
![Home Page of the ArcGIS website](assets/img/GISHomepage.png)
...
![Home Page of the Map Warper website](assets/img/MapWarperHome.png)
...
![A map that has been rectified by map warper](assets/img/91017.png)
...
| ![Stephen De Riel's map of 1850s US Railroads](assets/img/1850TrainsUS.png) | ![Map of MBTA Public Data from 2024](assets/img/MBTA2025Data.png) |
...
![MBTA map that has been rectified by map warper](assets/img/60402.png)
...
![Three images showing how map warper can turn a map into one that can be placed on top of a GPS map](assets/img/MapWarperProcess.png)
